        ...
        public IActionResult Edit(int id, News news)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        newsDBObject.Headline = news.Headline;
                        newsDBObject.Content = news.Content;
                        ...
                        return RedirectToAction("Article", "News", new { area = "", id = id });
                    }
                    else
                    {
                        ...
                        _dbContext.SaveChanges();
                        return RedirectToAction("Article", "News", new { area = "", id = news.ArticleId });
                    }
                }
